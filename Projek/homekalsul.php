...
<div class="topnav" id="myTopnav">
  <a href="homekalsul.php" class="active">Dashboard</a>
  <a href = "cabangkalsul.php"> Cabang </a>
  <a href = "kalsul.php"> Regional</a>
    <div class="dropdown">
...
$query = "SELECT * FROM kalsul ORDER BY 3 ASC";
...
{
	if ($performance == 0)
		 echo '<td><a href="emailLaporKalsul.php"><button>LAPOR</button></a></td>';
}
?>
</table>
</div>
