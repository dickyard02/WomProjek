...
<div class="topnav" id="myTopnav">
  <a href="homejatimbali.php" class="active">Dashboard</a>
  <a href = "cabangjatimbali.php"> Cabang </a>
  <a href = "jatimbali.php"> Regional</a>
    <div class="dropdown">
...
$query = "SELECT * FROM jatim_bali ORDER BY 3 ASC";
...
{
	if ($performance == 0)
		 echo '<td><a href="emailLaporJatimBali.php"><button>LAPOR</button></a></td>';
}
?>
</table>
</div>
