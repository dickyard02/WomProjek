...
<div class="topnav" id="myTopnav">
  <a href="homejabar.php" class="active">Dashboard</a>
  <a href = "cabangjabar.php"> Cabang </a>
  <a href = "jabar.php"> Regional</a>
    <div class="dropdown">
...
$query = "SELECT * FROM jawa_barat ORDER BY 3 ASC";
...
{
	if ($performance == 0)
		 echo '<td><a href="emailLaporJabar.php"><button>LAPOR</button></a></td>';
}
?>
</table>
</div>
