...
<div class="topnav" id="myTopnav">
  <a href="homesumut.php" class="active">Dashboard</a>
  <a href = "cabangsumut.php"> Cabang </a>
  <a href = "sumut.php"> Regional</a>
    <div class="dropdown">
...
{
	if ($performance == 0)
		 echo '<td><a href="emailLaptopSumut.php"><button>LAPOR</button></a></td>';
}
?>
</table>
</div>
